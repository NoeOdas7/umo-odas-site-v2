...
const equipe = [
  { nom: 'Mme Oury KAMISSOKO',                   role: 'Membre du Sous Comité Suivi',    organisation: 'AJCAF-AS',                           pays: '🇲🇱 Mali',          photo: '/equipe/Oury Kamissoko.jpg',            logo: '/partenaires/LOGO AJCAF-AS - Oury Kamissoko.pdf' },
  { nom: 'Mme Djossa Esther',                     role: 'Doctorante',                      organisation: 'Benin Women Alumni Association',      pays: '🇧🇯 Bénin',         photo: '/equipe/_DSC0204 (1) - esther DJOSSA.JPG', logo: '/pictos/IMG-20250730-WA0027 (2) - esther DJOSSA.jpg' },
  { nom: 'M. Tonfack Armando',                    role: 'MEAL Advisor',                    organisation: 'Le Centre ODAS',                     pays: '🇨🇲 Cameroun',      photo: '/equipe/Armando TONFACKArmanoTONFACK.JPG', logo: '/pictos/logo-odas.png' },
  { nom: 'Mme Kouakou Anasthasie Affoue Estelle', role: 'Project Manager',                 organisation: 'Africa Forward Advisory Group',      pays: '🇨🇮 Côte d\'Ivoire', photo: '/equipe/Anasthasie-Affoué-Estelle-Kouakou.jpg', logo: '/pictos/logo-odas.png'}, 
  { nom: 'Mme Fatou Bintou',                      role: 'Représentante Pays',              organisation: 'Population Council',                 pays: '🇸🇳 Sénégal',       photo: '/equipe/FatouBintouMbow.png',          logo: '/pictos/population-council.png' },
  { nom: 'M. Tanoh Noe',                          role: 'Assistant MEAL',                  organisation: 'Le Centre ODAS',                     pays: '🇨🇮 Côte d\'Ivoire', photo: '/equipe/photo - Noe Tanoh.png',         logo: '/pictos/logo-odas.png' },
  { nom: 'Dr Ramatou Ouedraogo',                  role: 'Chercheure',                      organisation: 'APHRC',                              pays: '🇰🇪 Kenya',         photo: '/equipe/RamatouOuedraogo.jpg',          logo: '/pictos/PEC-2. Logo Vertical APHRC (Texte Noir) (1) - Ramatou Ouedraogo.png' },
  { nom: 'Mme Deneo Désirée',                     role: 'Doctorante',                      organisation: 'Ligue Ivoirienne des Droits des Femmes', pays: '🇨🇦 Canada',    photo: '/equipe/DésiréeDeneoDésiréeDeneo.JPG', logo: '/pictos/lidf.png' },
  { nom: 'M. Noel ADANLAO',                       role: 'Chargé de Communication',         organisation: 'Le Centre ODAS',                     pays: '🇧🇯 Bénin',         photo: '/equipe/NoelAdanlaophoto.png',          logo: '/pictos/logo-odas.png' },
  { nom: 'Mme Reine Stéphanie THIOMBIANO',        role: 'Chargé de l\'engagement',         organisation: 'Le Centre ODAS',                     pays: '🌍 Afrique',         photo: '/equipe/ReineThiombiano.png',           logo: '/pictos/logo-odas.png' },
  { nom: 'Dr Beniel AGOSSOU',                     role: 'Conseiller Technique',            organisation: 'Le Centre ODAS',                     pays: '🌍 Afrique',         photo: '/equipe/beniel-agossou.png',            logo: '/pictos/public/logo-odas.png' },
  { nom: 'M. Karna KONE',                         role: 'Chargé de Communication',         organisation: 'Le Centre ODAS',                     pays: '🌍 Afrique',         photo: '/equipe/KarnaKone.png',                 logo: '/pictos/public/logo-odas.png' },
  { nom: 'Dr Dela Nai',                           role: 'Experte DSSR',                    organisation: 'Ibis Reproductive Health',            pays: '🌍 Afrique',         photo: '/equipe/Dela Nai Bio Photo_IbisRH - Dela Nai.jpg', logo: '/pictos/ibis.png' },
]
