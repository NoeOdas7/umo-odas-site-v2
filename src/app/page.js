...
const equipe = [
  { nom: 'Mme Oury KAMISSOKO',                   role: 'Membre du Sous Comité Suivi',    organisation: 'AJCAF-AS',                           pays: '🇲🇱 Mali',          photo: '/equipe/Oury Kamissoko.jpg',            logo: '/pictos/ajcaf-as.png' },
  { nom: 'Mme Djossa Esther',                     role: 'Doctorante',                      organisation: 'Benin Women Alumni Association',      pays: '🇧🇯 Bénin',         photo: '/equipe/_DSC0204 (1) - esther DJOSSA.JPG', logo: '/pictos/benin-women-alumni.png' },
  { nom: 'M. Tonfack Armando',                    role: 'MEAL Advisor',                    organisation: 'Le Centre ODAS',                     pays: '🇨🇲 Cameroun',      photo: '/equipe/Armando TONFACKArmanoTONFACK.JPG', logo: '/pictos/odas.png' },
  { nom: 'Mme Kouakou Anasthasie Affoue Estelle', role: 'Project Manager',                 organisation: 'Africa Forward Advisory Group',      pays: '🇨🇮 Côte d\'Ivoire', photo: '/equipe/Anasthasie-Affoué-Estelle-Kouakou.jpg', logo: '/pictos/africa-forward.png' },
  ...
  { nom: 'M. Tanoh Noe',                          role: 'Assistant MEAL',                  organisation: 'Le Centre ODAS',                     pays: '🇨🇮 Côte d\'Ivoire', photo: '/equipe/photo - Noe Tanoh.png',         logo: '/pictos/odas.png' },
  { nom: 'Dr Ramatou Ouedraogo',                  role: 'Chercheure',                      organisation: 'APHRC',                              pays: '🇰🇪 Kenya',         photo: '/equipe/RamatouOuedraogo.jpg',          logo: '/pictos/aphrc.png' },
  ...
  { nom: 'M. Noel ADANLAO',                       role: 'Chargé de Communication',         organisation: 'Le Centre ODAS',                     pays: '🇧🇯 Bénin',         photo: '/equipe/NoelAdanlaophoto.png',          logo: '/pictos/odas.png' },
  { nom: 'Mme Reine Stéphanie THIOMBIANO',        role: 'Chargé de l\'engagement',         organisation: 'Le Centre ODAS',                     pays: '🌍 Afrique',         photo: '/equipe/ReineThiombiano.png',           logo: '/pictos/odas.png' },
  { nom: 'Dr Beniel AGOSSOU',                     role: 'Conseiller Technique',            organisation: 'Le Centre ODAS',                     pays: '🌍 Afrique',         photo: '/equipe/beniel-agossou.png',            logo: '/pictos/odas.png' },
  { nom: 'M. Karna KONE',                         role: 'Chargé de Communication',         organisation: 'Le Centre ODAS',                     pays: '🌍 Afrique',         photo: '/equipe/KarnaKone.png',                 logo: '/pictos/odas.png' },
