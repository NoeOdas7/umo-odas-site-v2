...
const equipe = [
  ...
  { nom: 'Mme Kouakou Anasthasie Affoue Estelle', role: 'Project Manager',                 organisation: 'Africa Forward Advisory Group',      pays: '🇨🇮 Côte d\'Ivoire', photo: '/equipe/Anasthasie-Affoué-Estelle-Kouakou.jpg', logo: '/partenaires/afrcaforward.png'}, 
  ...
  { nom: 'M. Tanoh Noe',                          role: 'Assistant MEAL',                  organisation: 'Le Centre ODAS',                     pays: '🇨🇮 Côte d\'Ivoire', photo: '/equipe/Noé.jpg',         logo: '/partenaires/logo-odas.png' },
  { nom: 'Dr Ramatou Ouedraogo',                  role: 'Chercheure',                      organisation: 'APHRC',                              pays: '🇰🇪 Kenya',         photo: '/equipe/RamatouOuedraogo.jpg',          logo: '/partenaires/aphrc.png' },
  { nom: 'Mme Deneo Désirée',                     role: 'Doctorante',                      organisation: 'Ligue Ivoirienne des Droits des Femmes', pays: '🇨🇦 Canada',    photo: '/equipe/DésiréeDeneoDésiréeDeneo.JPG', logo: '/partenaires/laligue.jpg' },
  { nom: 'M. Noel ADANLAO',                       role: 'Chargé de Communication',         organisation: 'Le Centre ODAS',                     pays: '🇧🇯 Bénin',         photo: '/equipe/NoelAdanlaophoto.png',          logo: '/partenaires/logo-odas.png' },
