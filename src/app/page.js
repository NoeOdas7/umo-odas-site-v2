...
const equipe = [
  ...
  { nom: 'Mme Kouakou Anasthasie Affoue Estelle', role: 'Project Manager',                 organisation: 'Africa Forward Advisory Group',      pays: '🇨🇮 Côte d\'Ivoire', photo: '/equipe/Anasthasie-Affoué-Estelle-Kouakou.jpg', logo: '/logos/africa-forward.png' },
  { nom: 'Mme Fatou Bintou',                      role: 'Représentante Pays',              organisation: 'Population Council',                 pays: '🇸🇳 Sénégal',       photo: '/equipe/FatouBintouMbow.png',          logo: '/logos/population-council.png' },
  { nom: 'M. Tanoh Noe',                          role: 'Assistant MEAL',                  organisation: 'Le Centre ODAS',                     pays: '🇨🇮 Côte d\'Ivoire', photo: '/equipe/photo - Noe Tanoh.png',         logo: '/logos/odas.png' },
  { nom: 'Dr Ramatou Ouedraogo',                  role: 'Chercheure',                      organisation: 'APHRC',                              pays: '🇰🇪 Kenya',         photo: '/equipe/RamatouOuedraogo.jpg',          logo: '/logos/aphrc.png' },
  { nom: 'Mme Deneo Désirée',                     role: 'Doctorante',                      organisation: 'Ligue Ivoirienne des Droits des Femmes', pays: '🇨🇦 Canada',    photo: '/equipe/DésiréeDeneoDésiréeDeneo.JPG', logo: '/logos/lidf.png' },
  { nom: 'M. Noel ADANLAO',                       role: 'Chargé de Communication',         organisation: 'Le Centre ODAS',                     pays: '🇧🇯 Bénin',         photo: '/equipe/NoelAdanlaophoto.png',          logo: '/logos/odas.png' },
  { nom: 'Mme Reine Stéphanie THIOMBIANO',        role: 'Chargé de l\'engagement',         organisation: 'Le Centre ODAS',                     pays: '🌍 Afrique',         photo: '/equipe/ReineThiombiano.png',           logo: '/logos/odas.png' },
